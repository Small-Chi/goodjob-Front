    ...
    <v-card class="overflow-hidden">
      ...
      <v-sheet id="scrolling-techniques-4" class="overflow-y-auto" max-height="100vh">
        <v-container fluid style="background-color: var(--color-blue); padding: 0px; height: 100vh">
          ...
          <div class="sidebar" id="OwnerPageSIderbar">
            ...
            <div class="selfmeanu">
              <ul class="selfmeanuUl">
                <li class="col-xs-6">
                  <v-btn depressed exact color="var(--color-blue)" class="memBtn" :to="`/owner/${$route.params.id}/ownerself/`">
                    <v-icon class="memIcon me-xl-3 me-1" color="var(--color-white)">mdi-account-outline</v-icon>
                    <a class="textWhite ctext2">業主資訊</a>
                  </v-btn>
                </li>
                <li class="col-xs-6">
                  <v-btn depressed exact color="var(--color-blue)" class="memBtn" :to="`/owner/${$route.params.id}/cases/`">
                    <v-icon class="memIcon me-xl-3 me-1" color="var(--color-white)">mdi-folder-outline</v-icon>
                    <a class="textWhite ctext2">業主案件</a>
                  </v-btn>
                </li>
                <li class="col-xs-6">
                  <v-btn depressed exact color="var(--color-blue)" class="memBtn" v-if="nome" :to="`/owner/${owner._id}/ownerfavorite/`">
                    <v-icon class="memIcon me-xl-3 me-1" color="var(--color-white)">mdi-heart-outline</v-icon>
                    <a class="textWhite ctext2">收藏作品</a>
                  </v-btn>
                </li>
                <li class="col-xs-6">
                  <v-btn depressed exact color="var(--color-blue)" class="memBtn" v-if="nome" :to="`/owner/${owner._id}/ownercheck/`">
                    <v-icon class="memIcon me-xl-3 me-1" color="var(--color-white)">mdi-file-download-outline</v-icon>
                    <a class="textWhite ctext2">查看投稿</a>
                  </v-btn>
                </li>
                <li class="col-xs-6">
                  <v-btn depressed exact color="var(--color-blue)" class="memBtn" v-if="nome" :to="`/owner/${owner._id}/ownerdeal/`">
            ...
            <div class="selfmeanu2" v-if="me">
              ...
              <div class="meanu">
                <div class="row mt-1">
                  ...
                  <div class="col-4 num">{{ ownerinfo.assess }}</div>
                </div>
                <div class="row mt-1">
                  <div class="col-8 fw-700">
                  ...
                  <div class="col-4 num">{{ ownerinfo.good }}</div>
                </div>
                <div class="row mt-1">
                  <div class="col-8 fw-700">
                  ...
                  <div class="col-4 num">{{ ownerinfo.bad }}</div>
                </div>
            ...
            <div class="selfmeanu3" v-if="me">
              ...
              <div class="score">
                <div class="row mb-n8">
                  ...
                  <div class="col-10 num">{{ ownerinfo.assess }}</div>
                </div>
                <div class="row mb-n8">
                  <div class="col-2 fw-700">
                    <v-icon class="itemIcon" color="var(--color-lightY)">mdi-thumb-up</v-icon>
                  </div>
                  <div class="col-10 num">{{ ownerinfo.good }}</div>
                </div>
                <div class="row mb-n8">
                  <div class="col-2 fw-700">
                    <v-icon class="itemIcon" color="var(--color-lightY)">mdi-thumb-down</v-icon>
                  </div>
                  <div class="col-10 num">{{ ownerinfo.bad }}</div>
                </div>
              </div>
              <div class="meanu">
                <div class="priceMenu">
                  <div class="row mb-n8 ms-2" v-for="(price, index) in ownerinfo.prices" :key="'A' + index">
